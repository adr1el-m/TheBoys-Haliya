...
import { Activity, Globe, HeartPulse, Shield } from "lucide-react";
...
export default function Home() {
  ...
  const t = {
    English: {
      ...
      heroDesc:
        "Haliya uses advanced AI to assess your symptoms and guide you to the right level of care—instantly and anonymously.",
    ...
    Filipino: {
      ...
      heroDesc:
        "Ginagamit ng Haliya ang advanced AI para suriin ang iyong mga sintomas at gabayan ka sa tamang antas ng pangangalaga—agad-agad at anonimo.",
      ...
      {/* <nav className="bg-white/80 backdrop-blur-md border-b border-slate-100 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-500">
            <Link href="/triage" className="text-teal-600">
              {t.checker}
            </Link>
            <Link
              href="/public-health"
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={() =>
                setLanguage((l) => (l === "English" ? "Filipino" : "English"))
              }
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="space-y-4">
                ...
                <p className="text-slate-500 leading-relaxed">
                  Get instant feedback on symptom severity using Groq's
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-500 leading-relaxed">
                  Your assessments are anonymous. We only track regional trends
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-500 leading-relaxed">
                  By using Haliya, you contribute to early outbreak detection in
                  your region.
                </p>
              </div>
            </div>
